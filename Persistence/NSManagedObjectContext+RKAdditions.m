...
- (BOOL)saveToPersistentStore:(NSError **)error
{
    ...
    while (contextToSave) {
        ...
        if (! contextToSave.parentContext && contextToSave.persistentStoreCoordinator == nil) {
            LYLogError(@"Reached the end of the chain of nested managed object contexts without encountering a persistent store coordinator. Objects are not fully persisted.");
            return NO;
        }
